...
- **Background:** Specializing in machine learning, computer vision, and protocol analysis. I am currently exploring Web3 and building decentralized applications on the Stellar network.
...
## Why Stellar
If deployed on other blockchains (like Ethereum), continuously updating debt states could cost significant gas fees and take minutes to confirm. In traditional finance, settling transitive debts (e.g., A owes B, B owes C, so A pays C directly) requires manual calculation or cumbersome bank transfers. 
